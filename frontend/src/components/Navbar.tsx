  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 p-4">
      ...
      <div className="mx-auto max-w-5xl rounded-full bg-black/5 dark:bg-white/5 p-1 ring-1 ring-black/5 dark:ring-white/10 backdrop-blur-md">
        {/* Inner Core */}
        <div className="flex items-center justify-between px-6 py-2.5 rounded-full bg-white/70 dark:bg-black/70 shadow-[inset_0_1px_1px_rgba(255,255,255,0.15)]">
          {/* Logo */}
          <Link href="/">
            <Logo />
          </Link>
            ...
            {navItems.map((item) => {
              ...
              return (
                <Link
                  key={item.href}
                  href={item.href}
                  className={`flex items-center gap-1.5 px-4.5 py-2 rounded-full text-xs font-medium transition-premium ${
                    isActive
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              <button
                ...
                className="w-9 h-9 rounded-full flex items-center justify-center hover:bg-muted text-muted-foreground hover:text-foreground transition-premium active:scale-95"
